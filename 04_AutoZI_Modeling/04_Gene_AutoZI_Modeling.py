...
# Initialize the AutoZI model based on tuned parameters
autozi_g_std = AUTOZI(
...
# Store latent in .obsm for downstream visualization
...
# Expression filter for interpretability: genes with mean > 1 count
...
model_dir = "Modeling/PBMCs_AutoZI/Gene"
...
mdata_g_std.write("Modeling/PBMCs_AutoZI/Gene/mdata_gene_with_latent_PBMCs_AutoZI.h5mu")

print("✅ Model and gene-level MuData saved successfully.")
